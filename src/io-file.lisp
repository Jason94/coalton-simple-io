...
Example:
  ...
  `(define-instance (MonadIoFile ,monad-param :i => MonadIoFile ,monadT-form :i)
...
(coalton-toplevel
  ...
  (define-class ((MonadIo :m) (BaseIo :i) => MonadIoFile :m :i (:m -> :i))
    (exists?
...
(cl:defmacro implement-monad-io-file (monad)
  `(define-instance (MonadIoFile ,monad ,monad)
